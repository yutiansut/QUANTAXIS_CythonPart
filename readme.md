...
In [5]:  %timeit -n 2000 -r 1 accout_cython.send_order(code='000001',price=11,amount=100,time='2018-05-09',towards=QA.ORDER_DIRECTION.BUY,order_model=QA.ORDER_MODEL.MARKET,amount_model=QA.AMOUNT_MODEL.BY_AMOUNT)
20.8 µs ± 0 ns per loop (mean ± std. dev. of 1 run, 2000 loops each)
